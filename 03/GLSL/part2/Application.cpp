...
static const char *vshader = "mybrick.vert";
static const char *fshader = "mybrick.frag";
...
static void display( void )
{
    ...
    quad.selectBuffers( program, "vPosition", NULL, "vNormal", "vTexCoord" );
