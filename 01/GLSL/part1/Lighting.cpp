...
//
//  Contributor: Michael Lee (ml3406) (only changed the coefficients of phong for the three objects)
//
...
GLfloat k_cube[3]     = { 0.4f, 0.7f, 1.0f };
...
GLfloat k_cyl[3]      = { 0.1f, 0.7f, 0.6f };
...
GLfloat k_sph[3]      = { 0.6f, 0.7f, 1.5f };
