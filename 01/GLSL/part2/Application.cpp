...
static const char *vshader = "phong.vert";
static const char *fshader = "phong.frag";
...
static void display( void )
{
    ...
    cube.selectBuffers( program, "vPosition", NULL, "vNormal", NULL );
    ...
    cylinder.selectBuffers( program, "vPosition", NULL, "vNormal", NULL );
    ...
    sphere.selectBuffers( program, "vPosition", NULL, "vNormal", NULL );
